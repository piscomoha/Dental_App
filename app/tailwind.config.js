  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "book-open": {
          "0%": { opacity: "0", transform: "perspective(1200px) rotateY(-45deg) scale(0.95)" },
        ...
        "book-close": {
          ...
          "100%": { opacity: "0", transform: "perspective(1200px) rotateY(45deg) scale(0.95)" }
        }
      },
      animation: {
        ...
        "book-close": "book-close 0.4s ease-in forwards"
      },
    },
  },
  plugins: [animate],
