...
{
    public function index(){ return Facture::with('consultation.rendezVous.patient','paiements')->get(); }
    public function store(Request $r){ return Facture::create($r->all()); }
    public function show($id){ return Facture::with('consultation.rendezVous.patient','paiements')->findOrFail($id); }
